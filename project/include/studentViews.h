...
// 1. Student Overview Display (without vector)
...
// 2. Grade View Display (without vector)
...
// 3. Attendance View Display (without vector)
...
// View menu remains the same since it doesn't use vectors
